...
// the view, and we change the mPetHasChanged boolean to true.
    ...
    private void savePet() {
        ...
        values.put(PetEntry.COLUMNS_PET_NAME, nameString);
        values.put(PetEntry.COLUMNS_PET_BREED, breedString);
        values.put(PetEntry.COLUMNS_PET_GENDER, mGender);
        values.put(PetEntry.COLUMNS_PET_WEIGHT, weight);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        Log.e("Editor Activity", "E");
        if (data.moveToFirst()) {
            // Find the columns of pet attributes that we're interested in
            int nameColumnIndex = data.getColumnIndex(PetEntry.COLUMNS_PET_NAME);
            int breedColumnIndex = data.getColumnIndex(PetEntry.COLUMNS_PET_BREED);
            int genderColumnIndex = data.getColumnIndex(PetEntry.COLUMNS_PET_GENDER);
            int weightColumnIndex = data.getColumnIndex(PetEntry.COLUMNS_PET_WEIGHT);
